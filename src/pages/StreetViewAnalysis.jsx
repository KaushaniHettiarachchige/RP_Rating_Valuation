      ...
      <main className="page">
        ...
        {result && (
          <section className="card">
            ...
            <p>
              <b>Adjusted Annual Value:</b> {Number(result.annual_value).toFixed(2)} LKR
            </p>
            <p>
              <b>Annual Rates Payable:</b> {Number(result.annual_rates).toFixed(2)} LKR
            </p>
            <p>
              <b>Quarterly Rates:</b> {Number(result.quarterly_rates).toFixed(2)} LKR
            </p>
