...
const EstimateMeasurements = () => {
    ...
    const [predictedClass, setPredictedClass] = useState(navState.predictedClass || "buildings");
    ...
    const [totalLandArea, setTotalLandArea] = useState(navState.total_land_area_sqft || 4000.0);
    ...
    const handleEstimation = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:8001/estimate-measurements", {
                method: "POST",
                headers: {
        ...
        <div className="dashboard-container">
            ...
            <main className="main-content" style={{ padding: "2rem" }}>
                <section className="welcome-section" style={{ textAlign: "center", marginBottom: "2rem" }}>
                    <h1 style={{ color: "#2c3e50" }}>Step 5: Physical Feature Measurement</h1>
                    <p style={{ color: "#7f8c8d", fontSize: "1.1rem" }}>
                        Estimate the Building Footprint Area (FAB) based on AI classification and land boundary data.
                    </p>
                </section>
                ...
                <section className="form-section" style={{ display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", maxWidth: "700px", backgroundColor: "#fff", padding: "2rem", borderRadius: "10px", boxShadow: "0 10px 25px rgba(0,0,0,0.05)" }}>
                        <form onSubmit={handleEstimation} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        readOnly
                                        style={{ width: "100%", padding: "0.8rem 1rem", borderRadius: "6px", border: "1px solid #dcdde1", backgroundColor: "#f1f2f6", textTransform: "capitalize" }}
                                    />
                                </div>
                            </div>
                            ...
                            >
                                {loading ? "Calculating Dimensions..." : "Calculate Physical Measurements"}
                            </button>
                        </form>
                        ...
                        {result && (
                            <div style={{ marginTop: "2rem", padding: "1.5rem", border: "1px solid #bdc3c7", borderRadius: "8px", backgroundColor: "#f8f9fa" }}>
                                <h3 style={{ color: "#27ae60", marginBottom: "1rem" }}>📏 Results</h3>

                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
                                    <div style={{ backgroundColor: "#ecf0f1", padding: "1.5rem", borderRadius: "8px", borderLeft: "4px solid #2980b9" }}>
                                        <h4 style={{ margin: "0", color: "#2c3e50", fontSize: "0.9rem" }}>Total Land Area</h4>
                                        <div style={{ fontSize: "1.8rem", color: "#2980b9", fontWeight: "bold" }}>
                                            {result.total_land_area_sqft} <small style={{ fontSize: "0.8rem" }}>sq/ft</small>
                                        </div>
                                    </div>

                                    <div style={{ backgroundColor: "#fff", padding: "1.5rem", borderRadius: "8px", border: "2px solid #27ae60" }}>
                                        <h4 style={{ margin: "0", color: "#2c3e50", fontSize: "0.9rem" }}>Building Footprint (FAB)</h4>
                                        <div style={{ fontSize: "1.8rem", color: "#27ae60", fontWeight: "bold" }}>
                                            {result.estimated_feature_area_sqft} <small style={{ fontSize: "0.8rem" }}>sq/ft</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style={{ marginTop: "2rem", textAlign: "right" }}>
                                    <button
                                        ...
                                        style={{ padding: "0.8rem 1.5rem", backgroundColor: "#34495e", color: "#fff", border: "none", borderRadius: "6px", cursor: "pointer", fontWeight: "bold" }}
                                    >
