...
const ResidentPortal = () => {
  ...
  const verifyProperty = async () => {
    ...
    try {
      ...
      const [taxPaidEvents, ownershipEvents, registrationEvents] =
        await Promise.all([
          contract.queryFilter(
            contract.filters.TaxPaid(pId),
            START_BLOCK,
            "latest",
          ),
          contract.queryFilter(
            contract.filters.OwnershipTransferred(pId),
            START_BLOCK,
            "latest",
          ),
          contract.queryFilter(
            contract.filters.PropertyRegistered(pId),
            START_BLOCK,
            "latest",
          ),
        ]);
      ...
      console.error(err);
      setError(
        "❌ Property Not Found or Blockchain Error. Ensure Hardhat is running and property exists.",
      );
    }
    setLoading(false);
  };
  ...
  const downloadDeedPDF = async () => {
    ...
    try {
      ...
      pdf.text("OFFICIAL DIGITAL PROPERTY DEED", pageWidth / 2, 13, {
        align: "center",
      });
      pdf.setFontSize(8.5);
      pdf.setFont("helvetica", "normal");
      pdf.text(
        "Blockchain-Verified  •  Municipal Valuation Authority",
        pageWidth / 2,
        22,
        { align: "center" },
      );
        ...
        <div className="flex items-start gap-4 mb-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 leading-relaxed">
              Enter your Property ID to verify the official valuation against
              blockchain records and test the corruption detection system.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-emerald-800 font-medium">
                    All property information matches the blockchain signature.
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-rose-800 font-bold">
                    SECURITY ALERT: The displayed data does not match the
                    blockchain hash. Unauthorized modification detected!
                  </p>
                </div>
                <div className="flex-shrink-0">
          ...
          `}
              >
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <DataCard
                      label="Building Age"
                      value={`${displayData.buildingAge} years`}
                      variant="default"
                    />
                  </div>
                ...
                `}
                  ...
                  <div className="p-5 bg-gradient-to-br from-blue-900 to-blue-950 rounded-lg shadow-md">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <p className="font-semibold text-blue-300 text-sm mb-1">
                          Blockchain Integrity Hash (SHA-256)
                        </p>
                    ...
                    <p className="text-xs text-slate-400 leading-relaxed">
                      This cryptographic signature proves the authenticity of
                      the data. Any modification to the tax amount will cause a
                      hash mismatch, instantly exposing corruption.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="flex-shrink-0 bg-rose-200 p-3 rounded-lg">
                      <svg
                        className="w-8 h-8 text-rose-800"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                    ...
                    <div className="flex-1">
                      <p className="text-slate-700 leading-relaxed mb-4">
                        Click the button below to simulate a malicious database
                        hack. The system will immediately detect the tampering
                  ...
                  <div className="bg-slate-900 border-t border-slate-700 px-4 py-2 flex items-center justify-between">
                    <div className="flex items-center gap-4 text-xs font-mono">
                      <span className="text-slate-500">
                        Lines:{" "}
                        <span className="text-green-400">{logs.length}</span>
                      </span>
                      <span className="text-slate-500">
                        Status:
                        <span
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-blue-200 text-sm">
                              Complete history of all valuation changes recorded
                              on blockchain
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-amber-800 leading-relaxed">
                            This audit trail is permanently recorded on the
                            blockchain and cannot be deleted or modified.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              {isVerified && (
                <div className="mt-8">
                  <div
                    ref={deedRef}
                    className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl border-2 border-emerald-400 overflow-hidden shadow-xl"
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-white">
                            Digital Property Deed (QR Code)
                          </h3>
                          <p className="text-emerald-100 text-sm">
                            Verified authenticity - Generated only for
                    ...
                    <div className="p-6">
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="mt-3 text-xs text-emerald-800 font-bold uppercase tracking-wide">
                            Scan to Verify
                          </p>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="bg-white p-4 rounded-lg border border-emerald-300">
                            ...
                            <code className="block text-sm font-mono text-slate-800 bg-slate-50 p-3 rounded border border-slate-200 break-all">
                              PropertyID:{displayData.id} | Tax:
                              {displayData.tax} | Status:Verified
                            </code>
                          </div>
                          ...
                          <div className="bg-amber-50 p-4 rounded-lg border-2 border-amber-400">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                <p className="text-sm font-semibold text-amber-900 mb-1"></p>
                                <p className="text-sm text-amber-800 leading-relaxed">
                                  This QR code serves as a digital property deed
                                  that can be scanned by banks, notaries, or
                                  property buyers to instantly verify
                                  authenticity.
                                </p>
                              </div>
                            </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-sm mt-0.5">
                      Every on-chain event sealed permanently • Tamper-proof •
                      Cannot be deleted
                    </p>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-5 py-2.5 rounded-2xl text-sm font-bold shadow-md">
                  {timelineEvents.length}{" "}
                  {timelineEvents.length === 1 ? "Event" : "Events"} Found
                </div>
              </div>
                    ...
                    {timelineEvents.map((event, idx) => {
                      ...
                      return (
                        <div key={idx} className="relative pl-16">
                          {/* Timeline dot */}
                          <div
                            className={`absolute left-3 top-5 w-6 h-6 ${cfg.dotColor} rounded-full ring-4 ${cfg.ringColor} shadow-md flex items-center justify-center z-10`}
                          >
                          ...
                          {/* Event card */}
                          <div
                            className={`rounded-2xl border-2 ${cfg.cardBorder} bg-white shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200`}
                          >
                            {/* Card header */}
                            <div
                              className={`px-5 py-3 ${cfg.headerBg} border-b ${cfg.headerBorder} flex items-center justify-between flex-wrap gap-2`}
                            >
                              <div className="flex items-center gap-2.5">
                                ...
                                <span
                                  className={`font-bold text-base ${cfg.textColor}`}
                                >
                                  {cfg.title}
                                </span>
                                {idx === 0 && (
                              ...
                              <span
                                className={`text-xs px-3 py-1 rounded-full border font-mono font-semibold ${cfg.badge}`}
                              >
                            ...
                            <div className="p-5">
                              ...
                              {event.type === "PropertyRegistered" && (
                                <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 mb-4">
                                  <p className="text-xs text-blue-600 font-bold mb-2 uppercase tracking-wider">
                                ...
                                <div className="mb-4">
                                  <div className="grid grid-cols-3 gap-3 mb-3">
                                    <div className="bg-violet-50 rounded-xl p-3 border border-violet-200 text-center">
                                      <p className="text-xs text-violet-600 font-bold mb-1 uppercase tracking-wide">
                                        Assessed Value
                                      </p>
                                    ...
                                    <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-200 text-center">
                                      <p className="text-xs text-emerald-600 font-bold mb-1 uppercase tracking-wide">
                                        Tax Amount
                                      </p>
                                      <p className="font-bold text-slate-800 text-sm">
                                        LKR{" "}
                                ...
                                <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-200 mb-4 flex items-start gap-3">
                                  ...
                                  <div>
                                    <p className="text-sm font-bold text-emerald-800 mb-1">
                                      Tax obligation fulfilled on blockchain
                                    </p>
                                    <p className="text-xs text-emerald-600 font-semibold mb-1.5 uppercase tracking-wide">
                                      Authorized by (Council Wallet):
                                    </p>
                                    <p className="font-mono text-xs text-slate-700 break-all">
                                      {event.details.payer}
                                    </p>
                              ...
                              {event.type === "OwnershipTransferred" && (
                                <div className="mb-4 space-y-2">
                                  <div className="bg-orange-50 rounded-xl p-3 border border-orange-200 flex items-center gap-3">
                                    <span className="bg-orange-500 text-white text-xs font-bold px-2.5 py-1 rounded-lg uppercase tracking-wide flex-shrink-0">
                                      From
                                    </span>
                                  ...
                                  <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-200 flex items-center gap-3">
                                    <span className="bg-emerald-600 text-white text-xs font-bold px-2.5 py-1 rounded-lg uppercase tracking-wide flex-shrink-0">
                                      To
                                    </span>
                                    <p className="font-mono text-xs text-slate-800 break-all">
                                      {event.details.to}
                  ...
                  <div className="relative pl-16 mt-6">
                    ...
                    <div className="bg-slate-100 rounded-2xl border-2 border-dashed border-slate-300 px-5 py-3">
                      <p className="text-xs text-slate-500 font-semibold">
                        ⛓ Chain Origin — All records above are cryptographically
                        sealed
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-8 flex items-start gap-4 bg-amber-50 rounded-2xl border-2 border-amber-300 p-5 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-800 leading-relaxed">
                    This audit trail is permanently sealed on the Ethereum
                    blockchain. Each transaction hash is a cryptographic
                    fingerprint proving the event occurred at that exact block.
                    No authority — including the Municipal Council — can delete,
                    alter, or reorder any entry in this immutable ledger.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-xs">
                      Test Mode - System Integration Demo
                    </p>
                  </div>
                </div>
              ...
              {paymentStatus === "success" ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-600 mb-2">
                    Tax payment recorded on the blockchain.
                  </p>
                  {paymentTxHash && (
                  ...
                  <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-emerald-700">
                        Payment recorded on blockchain — tamper-proof
                      </p>
                    </div>
                  </div>
