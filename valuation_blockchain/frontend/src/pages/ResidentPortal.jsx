...
const ResidentPortal = () => {
  ...
  return (
    <div>
      ...
      <div className="mb-8 pb-6 border-b-2 border-green-100">
        <div className="flex items-start gap-4 mb-3">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 inline-flex rounded-xl border border-green-200 bg-white p-1 shadow-sm">
              <button
                type="button"
          ...
          <div className={`
            ...
            ${
              isVerified 
                ...
                : 'bg-gradient-to-br from-green-50 to-green-50 border-green-400'
            }
          `}>
            ...
            <div className="p-6">
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200 mb-6">
                ...
                <div className="flex items-center justify-between flex-wrap gap-3">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-bold border ${displayData.hasBankLoan ? 'bg-green-100 text-green-800 border-green-300' : 'bg-green-100 text-green-800 border-green-300'}`}>
              ...
              <div className="p-5 rounded-lg border-2 border-green-200 bg-green-50 mb-6">
                ...
                {userRole === 'owner' && (
                  <>
                    ...
                    <button
                      ...
                      disabled={!isVerified || transferLockedByTax || transferLockedByLoan || displayData.hasPendingTransfer || (!ethers.isAddress(newOwnerAddress || '') && !newOwnerNic.trim())}
                ...
                {displayData.hasPendingTransfer && (
                  <p className="mt-3 text-sm font-semibold text-lime-700">
                    Transfer Status: Pending Council Approval
                  </p>
                )}

                {transferStatus && (
                  <p className="mt-2 text-sm font-semibold text-green-800">{transferStatus}</p>
                )}
                ...
                {transferError && (
                  <p className="mt-2 text-sm font-semibold text-green-700">{transferError}</p>
                )}
              </div>
            ...
            <div className="bg-gradient-to-br from-green-900 to-green-950 rounded-xl border-2 border-green-700 overflow-hidden mb-8 shadow-2xl">
              ...
              <div className="bg-green-900 border-t border-green-700 px-4 py-2 flex items-center justify-between">
                <div className="flex items-center gap-4 text-xs font-mono">
                  <span className="text-green-500">Lines: <span className="text-green-400">{logs.length}</span></span>
      ...
      {/* STAMP DUTY & TRANSFER MODAL */}
      {showStampDutyModal && displayData && (
