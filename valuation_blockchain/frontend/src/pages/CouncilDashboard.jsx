    ...
    try {
      ...
      try {
        ...
        const summaryRes = await axios.post(
          `${BACKEND_URL}/api/generate-title-summary`,
          summaryPayload,
        );
        ...
        setLegalSummaryError(
          summaryErr.response?.data?.error ||
            "AI summary service unavailable. Please check the GEMINI_API_KEY.",
        );
      } finally {
    ...
    <div>
        ...
        <div className="flex items-start gap-4 mb-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 leading-relaxed">
              Input property details. The system will automatically calculate
              tax using the multi-criteria algorithm and record it on the
              blockchain.
            </p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <option value="A">
              Zone A - Luxury Residential (Rate: 8,000 LKR)
            </option>
            <option value="B">
              Zone B - Standard Residential (Rate: 6,000 LKR)
            </option>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-3 border-b-2 border-blue-700">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-bold text-white">
                Contractor's Test Method Preview
              </h4>
            </div>
          </div>
          <div className="p-5 bg-white">
            <div className="text-sm text-slate-700 space-y-2 font-mono">
              ...
              <p className="flex items-center gap-2">
                ...
                <span>
                  Gross Cost × ({form.buildingAge || "?"} years × 2%, max 50%)
                </span>
              </p>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-purple-900">
                      🎉 Digital Identity Generated!
                    </h3>
                    <p className="text-sm text-purple-700">
                      Custodial wallet created for property owner
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-lg border border-purple-200">
                    ...
                    <p className="text-xs text-purple-600 mt-2">
                      ✅ This address can receive property ownership tokens
                    </p>
                  </div>
                  ...
                  <div className="bg-emerald-50 p-4 rounded-lg border-2 border-emerald-300">
                    ...
                    <p className="text-xs text-emerald-700 mt-2">
                      ✅ This hash uniquely identifies the blockchain
                      transaction and can be used to verify the record.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xs text-slate-500 font-mono">
                          {status.algorithm.sqFt} sqft ×{" "}
                          {status.algorithm.constructionRate} LKR/sqft
                        </p>
                      </div>
                      <p className="text-xl font-bold text-blue-700">
                        {parseInt(status.algorithm.grossCost).toLocaleString()}{" "}
                        LKR
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xs text-rose-700 font-mono">
                          {status.algorithm.buildingAge} years × 2% ={" "}
                          {status.algorithm.depreciationPercentage}
                        </p>
                      </div>
                      <p className="text-xl font-bold text-rose-700">
                        -
                        {parseInt(
                          status.algorithm.depreciationAmount,
                        ).toLocaleString()}{" "}
                        LKR
                      </p>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xs text-indigo-700 font-mono">
                          ECV × {status.algorithm.decapitalizationRate}{" "}
        ...
        <div className="mb-8 pb-6 border-b-2 border-slate-100">
          <div className="flex items-start gap-4 mb-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-600 leading-relaxed">
                Transfer property title to a new owner.{" "}
                <span className="font-bold text-amber-700">Note:</span> Tax must
                be paid before transfer can proceed (Transaction Integrity
                Check).
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleTransferSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <InputField
              ...
              onChange={(e) =>
                setTransferForm({ ...transferForm, propertyId: e.target.value })
              }
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-800 leading-relaxed">
                  This system prevents property transfers if taxes are unpaid.
                  The blockchain will automatically reject the transaction..
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white p-6">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl border-2 border-purple-300 mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-purple-900">
                        New Owner Wallet Generated
                      </h3>
                      <p className="text-sm text-purple-700">
                        NIC: {transferStatus.newOwnerWallet.nic}
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-5 rounded-lg">
                  <p className="font-semibold text-emerald-400 text-sm mb-2">
                    Transaction Hash:
                  </p>
                  <code className="block bg-slate-950 text-emerald-400 px-4 py-3 rounded font-mono text-xs break-all border border-slate-700">
                  ...
                  <div className="bg-gradient-to-r from-indigo-600 to-violet-600 px-5 py-3 flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-white text-sm">
                        AI-Generated Legal Title Summary
                      </p>
                      <p className="text-indigo-200 text-xs">
                        Powered by Google Gemini · Municipal Registrar Format
                      </p>
                    </div>
                  </div>
                    ...
                    {legalSummaryLoading && (
                      <div className="flex items-center gap-3 text-indigo-700">
                        ...
                        <span className="text-sm italic">
                          Drafting official legal summary via Gemini AI...
                        </span>
                      </div>
                    )}
                      ...
                      <div className="bg-white border border-indigo-200 rounded-lg p-5">
                        ...
                        {legalSummaryWarning ? (
                          ...
                          <div className="mt-3 pt-3 border-t border-indigo-100 flex items-center gap-2 text-xs text-indigo-500">
                            ...
                            <span>
                              Generated by Gemini · gemini-2.0-flash-lite ·{" "}
                    ...
                    {transferStatus.requiresPayment && (
                      <div className="bg-white p-4 rounded-lg border-2 border-rose-400">
                        <p className="text-sm font-semibold text-rose-900 mb-2">
                          🛡️ Transaction Integrity Protection Active
                        </p>
                        <p className="text-sm text-rose-800 leading-relaxed">
                          The blockchain has automatically blocked this transfer
                          because the property tax has not been paid.
                        </p>
                        <div className="mt-3 bg-rose-100 p-3 rounded border border-rose-300">
                          ...
                          <ol className="text-xs text-rose-800 mt-1 ml-4 list-decimal space-y-1">
                            ...
                            <li>
                              Verify the property (Property ID:{" "}
                              {transferForm.propertyId})
                            </li>
