          ...
          <div className="inline-flex bg-white rounded-xl shadow-lg border border-slate-200 p-1.5">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className={`text-xs font-normal ${activeTab === 'resident' ? 'text-emerald-100' : 'text-slate-500'}`}>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className={`text-xs font-normal ${activeTab === 'council' ? 'text-amber-100' : 'text-slate-500'}`}>
                  Assess Properties
                </div>
              </div>
            </button>
