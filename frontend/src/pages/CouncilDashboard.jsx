        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <InputField
              ...
              onChange={(e) =>
                setForm({ ...form, buildingAge: e.target.value })
              }
            ...
            <div className="flex items-start gap-4 mb-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 leading-relaxed">
                  ...
                  <span className="font-bold text-amber-700">Note:</span> Tax
                  must be paid before transfer can proceed (Transaction
                  Integrity Check).
                </p>
              </div>
            </div>
                      ...
                      {transferStatus.requiresPayment && (
                        <div className="bg-white p-4 rounded-lg border-2 border-rose-400">
                          ...
                          <p className="text-sm text-rose-800 leading-relaxed">
                            The blockchain has automatically blocked this
                            transfer because the property tax has not been paid.
                          </p>
